...
export function generateOSMXML(changesetData: ChangesetData, changesetId: string | null = null): string {
  ...
  if (!changesetData || !changesetData.changeset) {
  ...
  console.log('🔍 Changeset tags:', changesetData.changeset.tag);
  console.log('🔍 Modify nodes count:', changesetData.modify?.length || 0);
